...
export function AchievementsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-0 bottom-0 w-[280px] md:w-[480px] lg:w-[580px] lg:right-[220px] xl:right-[320px] pointer-events-none overflow-hidden flex items-center justify-center">
